...
public class SacolaServiceImpl implements SacolaService {
    ...
    public Item incluirItemNaSacola(ItemDto itemDto) {
        ...
        if (itensDaSacola.isEmpty()) {
            ...
            Restaurante restauranteDoItemParaAdicionar = item.getProduto().getRestaurante();
            if (restauranteAtual.equals(restauranteDoItemParaAdicionar)) {
                itensDaSacola.add(item);
            } else {
                throw new RuntimeException("Não é possível adicionar produtos de restaurantes diferetes. Feche a sacola ou esvazie.");
            }
        }
